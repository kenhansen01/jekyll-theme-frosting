      ...
      if(store[ref].teaser){
        var searchitem =
          '<div class="list__item">'+
            '<article class="mixer__item" itemscope itemtype="https://schema.org/CreativeWork">'+
              '<h2 class="mixer__item-title" itemprop="headline">'+
                '<a href="'+store[ref].url+'" rel="permalink">'+store[ref].title+'</a>'+
              '</h2>'+
              '<div class="mixer__item-teaser">'+
                '<img src="'+store[ref].teaser+'" alt="">'+
              '</div>'+
              '<p class="mixer__item-excerpt" itemprop="description">'+store[ref].excerpt.split(" ").splice(0,20).join(" ")+'...</p>'+
            '</article>'+
          '</div>';
      }
      else{
