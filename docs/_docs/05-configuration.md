...
Settings that affect your entire site can be changed in [Jekyll's configuration file](https://jekyllrb.com/docs/configuration/): `_config.yml`, found in the root of your project. If you don't have this file you'll need to copy or create one using the theme's [default `_config.yml`](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/_config.yml) as a base.
...
```yaml
theme: jekyll-theme-frosting-jekyll
```
...
```yaml
frosting_flavor: "default" # "air", "aqua", "contrast", "dark", "dirt", "neon", "mint", "plum" "sunrise"
```

**Note:** If you have made edits to the theme's CSS files be sure to update [`/assets/css/main.scss`](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/assets/css/main.scss) to include `@import "jekyll-theme-frosting/skins/{{ site.frosting_flavor | default: 'default' }}"; // skin` before the `jekyll-theme-frosting` import.
{: .notice--warning}
...
In the case of the Frosting demo site it's hosted on GitHub at <https://kenhansen01.github.io/jekyll-theme-frosting>. To correctly set this base path I'd use `url: "https://kenhansen01.github.io"` and `baseurl: "/jekyll-theme-frosting"`.
...
"NWO" stands for "name with owner." It is GitHub lingo for the username of the owner of the repository plus a forward slash plus the name of the repository, e.g. `kenhansen01/jekyll-theme-frosting`, where **mmistakes** is the owner and **jekyll-theme-frosting** is the repository name.
...
```yaml
repository: # GitHub username/repo-name e.g. "kenhansen01/jekyll-theme-frosting"
```
...
repository  : # Git username/repo-name e.g. "kenhansen01/jekyll-theme-frosting"
comments:
...
Default settings have been provided in [`staticman.yml`](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/staticman.yml) and are commented to guide you through setup. View the [full list of configurations](https://staticman.net/docs/configuration).
...
**Note:** By default the site feed is linked in two locations: inside the [`<head>` element](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/_includes/head.html) and at the bottom of every page in the [site footer](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/_includes/footer.html).
{: .notice--info}
...
For faster and more relevant search ([see demo](https://kenhansen01.github.io/jekyll-theme-frosting-algolia-search/)):
...
2. Under **Look and feel** choose the "Results only" layout and a theme (*Minimalist* is a good choice to match the default look of the Frosting).
...
And of course any default value can be overridden by settings in a post, page, or collection file. All you need to do is specify the settings in the YAML Front Matter. For more examples be sure to check out the demo site's [`_config.yml`](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/_config.yml).
