...
If you're using the [Ruby Gem]({{ "/docs/quick-start-guide/#ruby-gem-method" | relative_url }}) or [remote theme]({{ "/docs/quick-start-guide/#github-pages-method" | relative_url }}) versions of Frosting, upgrading is fairly painless.
...
```
<!--
  Frosting Jekyll Theme 4.15.2 by Michael Rose
  Copyright 2013-2018 Michael Rose - mademistakes.com | @mmistakes
  Free for personal and commercial use under the MIT license
  https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/LICENSE
-->
```
...
Simply run `bundle update` if you're using Bundler (have a `Gemfile`) or `gem update jekyll-theme-frosting-jekyll` if you're not.

When using Bundler you can downgrade or lock the theme to a specific release ([tag](https://github.com/kenhansen01/jekyll-theme-frosting/tags)), branch, or commit. Instead of `gem "jekyll-theme-frosting-jekyll"` you'd add the following to your `Gemfile`:

```ruby
gem "jekyll-theme-frosting-jekyll", :git => "https://github.com/kenhansen01/jekyll-theme-frosting.git", :tag => "4.15.2"
```
...
When setting `remote_theme: "kenhansen01/jekyll-theme-frosting@4.15.2"` in your `_config.yml` you may also optionally specify a branch, [tag](https://github.com/kenhansen01/jekyll-theme-frosting/tags), or commit to use by appending an @ and the Git ref.

For example you can roll back to release 4.8.1 with `kenhansen01/jekyll-theme-frosting@4.8.1` or a specific commit with `kenhansen01/jekyll-theme-frosting@bbf3cbc5fd64a3e1885f3f99eb90ba92af84063d`). For a complete list of theme versions consult the [releases page](https://github.com/kenhansen01/jekyll-theme-frosting/releases).
