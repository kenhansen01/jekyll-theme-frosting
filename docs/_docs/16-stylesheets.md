...
The theme's `assets/css/main.css` file is built from several SCSS partials located in [`_sass/`](https://github.com/kenhansen01/jekyll-theme-frosting/tree/master/_sass) and is structured as follows:

```bash
jekyll-theme-frosting
├── _sass
|  └── jekyll-theme-frosting
...
1. Copy directly from the Frosting theme gem

   - Go to your local Frosting gem installation directory (run 
     `bundle show jekyll-theme-frosting-jekyll` to get the path to it).
...
2. Copy from this repo.
   ...
   - Copy the contents of [assets/css/main.scss](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/assets/css/main.scss) 
     to `<your_project>`.
   - Customize what you want inside `<your_project/assets/css/main.scss`.
...
**1.** Add this Google Fonts script to [`_includes/head/custom.html`](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/_includes/head/custom.html):
