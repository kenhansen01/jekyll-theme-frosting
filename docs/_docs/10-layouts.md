...
The bread and butter of any theme. Below you'll find the layouts included with Frosting, what they look like and the type of content they've been built for.
...
| Name                 | Layout | Example |
| -------------------- | ------ | ------ |
| [Posts Archive](https://kenhansen01.github.io/jekyll-theme-frosting/year-archive/) | `layout: posts` | [year-archive.md](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/docs/_pages/year-archive.md) |
| [Categories Archive](https://kenhansen01.github.io/jekyll-theme-frosting/categories/) | `layout: categories` | [category-archive.md](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/docs/_pages/category-archive.md) |
| [Category Archive](https://kenhansen01.github.io/jekyll-theme-frosting/categories/edge-case/) | `layout: category` | [edge-case.md](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/docs/_pages/edge-case.md) |
| [Tags Archive](https://kenhansen01.github.io/jekyll-theme-frosting/tags/) | `layout: tags` | [tag-archive.md](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/docs/_pages/tag-archive.md) |
| [Tag Archive](https://kenhansen01.github.io/jekyll-theme-frosting/tags/markup/) | `layout: tag` | [markup.md](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/docs/_pages/markup.md) |
| [Collection Archive](https://kenhansen01.github.io/jekyll-theme-frosting/recipes-archive/) | `layout: collection` | [recipes-archive.md](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/docs/_pages/recipes-archive.md) |
...
A page with a search form. Add `layout: search` to the YAML Front Matter similar to [this example](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/test/_pages/search.md) on the test site.
...
If you'd like to add, remove, or change the order of these default links you can do so by editing [`_includes/social-share.html`](https://github.com/kenhansen01/jekyll-theme-frosting/blob/master/_includes/social-share.html).
