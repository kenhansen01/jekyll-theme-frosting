...
**1.** For a **new site**, install the `jekyll-theme-frosting-jekyll` gem, remote theme, or fork the Frosting repo on GitHub following the steps outlined in the [*Quick-Start Guide*]({{ "/docs/quick-start-guide/" | relative_url }}).
...
[<i class="fas fa-download"></i> Download Frosting Theme](https://github.com/kenhansen01/jekyll-theme-frosting/archive/master.zip){: .btn .btn--success}

**ProTip:** Be sure to remove `/docs` and `/test` if you forked or downloaded Frosting. These folders contain documentation and test pages for the theme and you probably don't littering up in your repo.
{: .notice--info}
...
gem "jekyll"
gem "jekyll-theme-frosting-jekyll"
...
**ProTip:** To be bleeding edge install the latest (unreleased) version of Frosting by adding this line to your `Gemfile`: `gem "jekyll-theme-frosting-jekyll", :github => "kenhansen01/jekyll-theme-frosting"`.
{: .notice--info}
